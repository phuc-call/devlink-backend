// src/features/post/pages/GroupsFeedPage.tsx
...
export default function GroupsFeedPage() {
    ...
    const loadFeed = useCallback((pageNum: number, reset = false) => {
        ...
        getFeedApi.getGroupsFeed(pageNum, 4)
            .then(res => {
            ...
            .catch(err => { console.error('Lỗi load groups feed:', err); })
            .finally(() => {
        ...
        return (
            <div style={{
                ...
                <p style={{ margin: 0, fontSize: 13 }}>
                    Tham gia thêm các nhóm để xem thêm nội dung!
                </p>
            </div>
        );
    }
