...
// import type {UserProfileResponse} from "../../../../types/profile.types.ts";
// interface Props {
...
//                     {/* ── Avatar thật từ profile ── */}
//                     <div className={styles.createAvatar}>
//                         {profile?.avatarUrl
//                             ? <img src={profile.avatarUrl} alt="avatar" className={styles.createAvatarImg} />
//                             : <span className={styles.createAvatarInitials}>
//                 {profile?.fullName
