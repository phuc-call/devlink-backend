...
export default function LeftSidebar() {
    ...
    const isUtilitiesRoute = ['/notifications', '/templates', '/hidden'].some(p => location.pathname.startsWith(p));

    const isPathActive = (path: string) => {
        if (path === '/') return location.pathname === '/';
        if (path === '/notifications') return isUtilitiesRoute;
        ...
        return (
            <div className={styles.sidebar}>
                <div className={styles.subSidebarHeader}>
                    ...
                    <h2 className={styles.subSidebarTitle}>Tiện ích</h2>
                </div>
                <nav className={styles.nav}>
                    <NavLink to="/notifications" className={({ isActive }) => `${styles.navItem} ${isActive ? styles.navActive : ''}`}>
                    ...
                    <NavLink to="/templates" className={({ isActive }) => `${styles.navItem} ${isActive ? styles.navActive : ''}`}>
                        <span className={styles.navIcon}>
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
                        ...
                        <span className={styles.navLabel}>File đề xuất</span>
                    </NavLink>
                    <NavLink to="/hidden" className={({ isActive }) => `${styles.navItem} ${isActive ? styles.navActive : ''}`}>
                        <span className={styles.navIcon}>
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
                        ...
                        <span className={styles.navLabel}>Nội dung ẩn</span>
                    </NavLink>
                </nav>
            </div>
        );
        ...
        return (
            <div className={styles.sidebar}>
                <div className={styles.subSidebarHeader}>
                    ...
                    <h2 className={styles.subSidebarTitle}>Dashboard</h2>
                </div>
                <SidebarDashboard />
            </div>
        );
...
function SidebarDashboard() {
    return (
        <div className={styles.indexGroup}>
            <nav className={styles.nav}>
                <NavLink to="/dashboard/user-info" className={({ isActive }) => `${styles.navItem} ${isActive ? styles.navActive : ''}`}>
                    <span className={styles.navIcon}>
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
                    </span>
                    <span className={styles.navLabel}>Thông tin người dùng</span>
                </NavLink>
                <NavLink to="/dashboard/general" className={({ isActive }) => `${styles.navItem} ${isActive ? styles.navActive : ''}`}>
                    <span className={styles.navIcon}>
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="18" height="18" rx="2" ry="2"></rect><line x1="3" y1="9" x2="21" y2="9"></line><line x1="9" y1="21" x2="9" y2="21"></line></svg>
                    </span>
                    <span className={styles.navLabel}>Thông tin chung</span>
                </NavLink>
                <NavLink to="/dashboard/posts" className={({ isActive }) => `${styles.navItem} ${isActive ? styles.navActive : ''}`}>
                    <span className={styles.navIcon}>
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><polyline points="10 9 9 9 8 9"></polyline></svg>
                    </span>
                    <span className={styles.navLabel}>Thông tin bài viết</span>
                </NavLink>
                <NavLink to="/dashboard/interests" className={({ isActive }) => `${styles.navItem} ${isActive ? styles.navActive : ''}`}>
                    <span className={styles.navIcon}>
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"></path></svg>
                    </span>
                    <span className={styles.navLabel}>Nội dung quan tâm</span>
                </NavLink>
            </nav>
        </div>
    );
