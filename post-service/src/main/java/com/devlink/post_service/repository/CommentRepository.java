...
public interface CommentRepository extends JpaRepository<Comment,Long> {
    ...
    @Query("""
            SELECT new com.devlink.post_service.dto.response.CommentSummaryResponse(
                c.id, c.postId, c.authorId, c.parentCommentId,
            ...
            ORDER BY
                ...
                c.createdAt DESC
            """)
    Page<CommentSummaryResponse> findTopLevelSortByDate(
            @Param("postId")      Long postId,
    ...
    @Query("""
        ...
        ORDER BY
            ...
            c.likeCount DESC
        """)
    Page<CommentSummaryResponse> findTopLevelSortByLike(
            @Param("postId")      Long postId,
            @Param("postOwnerId") Long postOwnerId,
            @Param("statuses")    List<CommentStatus> statuses,
            Pageable pageable
