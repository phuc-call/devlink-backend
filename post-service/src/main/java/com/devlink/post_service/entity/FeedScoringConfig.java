...
/**
 * Stores admin-configurable parameters for the personalized feed scoring
 * system.
 *
 ...
 * feed.fallback_threshold - minimum result count before falling back to
 * trending
 * interest.decay_rate - multiplier applied per elapsed day since last
 * interaction
 */
@Entity
@Table(name = "feed_scoring_config", indexes = {
